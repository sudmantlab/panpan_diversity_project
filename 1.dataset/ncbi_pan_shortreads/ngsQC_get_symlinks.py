...
rule all:
    input:
        expand('accessions/{accession}_1.fastq.gz', accession=accessions),
	    expand('accessions/{accession}_2.fastq.gz', accession=accessions),


rule prefetch_samples:
    output: 
        'accessions/{accession}_1.fastq.gz',
        'accessions/{accession}_2.fastq.gz'
    shell: """
